...
function Purchase_pr0301r_Search({
  history,
  programName,
  parentState,
  useSearch,
  ...
  const handleClickOpen = (code_kind) => {
    ...
    if (code_kind === "date") {
      ...
      if (code_kind === "buy_cust") {
        setCodeListData(
          JSON.parse(window.sessionStorage.getItem("buy_cust_list"))
        );
        ...
        <Container className={classes.root}>
          ...
          <table className={classes.table}>
            ...
            <tbody>
              <tr>
                <td align="right">
                  <span className={classes.span}>매입일</span>
                </td>
                <td>
                  <CssTextField
                    fullWidth
            ...
            <tbody>
              <tr>
                <td align="right">
                  <span className={classes.span}>매입처</span>
                </td>
                <td>
                  <CssTextField
                    fullWidth
                    ...
                    onClick={() => handleClickOpen("buy_cust")}
                    value={buy_cust_name}
                    variant="outlined"
                    InputProps={{
                      readOnly: true,
                  ...
                  />
                  {buy_cust_name.length > 0 && (
                    <IconButton
                      className={classes.clearIcon}
                      onClick={() => handleClearIcon("buy_cust")}
                    >
                      <ClearIcon fontSize="small" />
                    </IconButton>
                  )}
...
Purchase_pr0301r_Search.propTypes = {
...
export default withRouter(Purchase_pr0301r_Search);
